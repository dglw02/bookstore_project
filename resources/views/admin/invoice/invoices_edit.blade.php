...
<form action="{{url('/admin/invoice/'.$invoice->invoices_id.'/edit')}}" method="POST">
    ...
    <br>
    <label for="invoices_date">Ngày nhập:</label>
    <br>
    ...
    <table id="mytable">
        ...
        ?>
            <tr>
                ...
                <td><input name="quantity[]" type="text" class="form-control" placeholder="Số lượng" value="{{$invoices_detail_quantity[$i]}}"></td>
                <td><input name="price[]" type="number" class="form-control" placeholder="Giá sản phẩm" value="{{$invoices_detail_price[$i]}}"></td>
            </tr>
        <?php } ?>
    </table>
    <br>
